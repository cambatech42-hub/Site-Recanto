...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/90 shadow-md backdrop-blur-sm">
      <div className={`container mx-auto px-4 md:px-6 flex justify-between items-center relative overflow-visible transition-all duration-300 ${scrolled ? 'h-16 md:h-18' : 'h-20 md:h-24'}`}>
        <Link
          to="/"
